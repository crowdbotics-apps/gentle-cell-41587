"""
Django settings for gentle_cell_41587 project.
...
ROOT_URLCONF = 'gentle_cell_41587.urls'
...
WSGI_APPLICATION = 'gentle_cell_41587.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gentle_cell_41587 API",
    "DESCRIPTION": "API documentation for gentle_cell_41587 App",
    "VERSION": "v1",
}
